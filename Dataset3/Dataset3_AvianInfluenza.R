...
# Nov 2022.
# 
# Aim: Load and explore a dataset to evaluate the effects of phylogeny on
# susceptibility to avian influenza in Australian birds
#
# Citation: Wille et al., (under review) - preprint in https://doi.org/10.1101/2022.02.14.480463
# Data provider and contact details: Marcel Klaassen marcel.klaassen@deakin.edu.au
#
...
Y <- read.csv("Dataset3/birddata.csv", na.strings = c("", "NA"),
...
vars_of_interest <- c('Year2', 'group', 'Ecotype', 'Age', 'BandNumber', 'Season',
...
print(av.host.tree) # visualise the tree

## Plot it ---
# library(phytools)
par(mfrow = c(1,1)) # set up for plotting, to plot 1 pane only. 
